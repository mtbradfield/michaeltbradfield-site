...
title: The Hinge
permalink: /endorsement/the-hinge/

form: reflection

back_link: /endorsement/
back_label: Endorsement

feature_excerpt: >
  Chaplains serve at the fringes: in military formations, hospitals,
  correctional institutions, veterans’ settings, and other environments
  where the Church sends ministers to represent it in public institutions.

  Life at the edge can be lonely. Over time, I learned that survival in
  those spaces depends on two kinds of connection.
